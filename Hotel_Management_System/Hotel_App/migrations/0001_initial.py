    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rcost', models.DecimalField(decimal_places=2, max_digits=10)),
                ('rimg', models.ImageField(default='profilepic.png', upload_to='Roomsimg/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Hotel_App.rooms')),
                ('uid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
